export const videoDetails = [
    {
      ...
      pdf_en: require('@/assets/pdfs/english/Bunty and Bubbly_ENG_UK.pdf'),
      pdf_punjabi: require('@/assets/pdfs/punjabi/Bunty and Bubbly_PUN.pdf'),
    ...
    },
    {
      ...
      pdf_en: require('@/assets/pdfs/english/The Moon and the Cap_ENG_UK.pdf'),
      pdf_punjabi: require('@/assets/pdfs/punjabi/The Moon and the Cap_PUN.pdf'),
